...
export default function StudentDashboardPage() {
  ...
  if (user.role !== 'STUDENT') return <div className="p-6">Access denied. This dashboard is for students.</div>;
    ...
    <div className="min-h-screen bg-white text-black p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="border rounded-lg p-4">
          ...
          <p className="text-sm text-gray-600">Explore enrolled and recommended courses.</p>
        </div>
        <div className="border rounded-lg p-4">
          <h2 className="font-medium mb-2">Mentor Sessions</h2>
