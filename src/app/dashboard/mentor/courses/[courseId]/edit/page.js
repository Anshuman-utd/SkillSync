    ...
    async function loadData() {
      try {
        ...
        if (course.learningOutcomes) {
            try {
                const parsedOutcomes = JSON.parse(course.learningOutcomes);
                if (Array.isArray(parsedOutcomes) && parsedOutcomes.length > 0) {
    ...
    try {
      ...
      const res = await fetch(`/api/courses/${courseId}`, {
        ...
        body: JSON.stringify({
          ...
          imageUrl, // If null, backend keeps existing image
    ...
    <div className="max-w-4xl mx-auto pb-20">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white p-8 rounded-xl border border-gray-100 shadow-sm">
          ...
          <p className="text-gray-500 text-sm mb-6">Update the main details about your course</p>
